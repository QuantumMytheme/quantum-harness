...
window.SCOREBOARD_DATA = {
  ...
  "rows": [
    ...
    },
    {
      ...
      "task": "state_prep",
      "rank": 1,
      "paradigm_short": "euler-cz-sandwich",
      "metricName": "fidelity",
      "metricValue": "1.000",
      "metricSub": "≥ undefined · base undefined",
      "costLabel": "2q 2 · depth 11",
      "model": "sonnet-5",
      "quality": {
        "correctness": 1,
        "margin": 1,
      ...
      "bundleUrl": "https://github.com/craigm26/run-ghz3he-craigm26/blob/main/bench/quantum-judge/quantum-proof-ghz3he-craigm26.json",
      "bundle_sha256": null,
      "reverify": "curl -sL https://raw.githubusercontent.com/craigm26/run-ghz3he-craigm26/main/bench/quantum-judge/quantum-proof-ghz3he-craigm26.json -o bundle.json && python3 bench/quantum-judge/judge_verify.py bundle.json",
      ...
      "gaps": [
        {
          "kind": "classical-baseline",
          "label": "no classical-baseline row — the board invites one so the quantum-vs-classical gap is visible (untried)",
          "command": "bin/new-run.sh run-ghz3_he-classical --remix ghz3_he"
        },
        {
          "kind": "hardware",
          "label": "no hardware overlay — no ACCEPTed design here has been run on a device (untried; see HARDWARE.md)",
          "command": "bin/new-run.sh run-ghz3_he-hw --remix ghz3_he"
        }
      ]
    },
    {
  ...
  "frontier": {
    ...
    "tfim3": {
      ...
      "gap": "Only one verified entry so far (hardware-efficient, gap 0.0143 at 2 2q gates) — the frontier is a single point. A second paradigm at a different cost is untried."
    },
    "ghz3_he": {
      "task": "state_prep",
      "metricName": "fidelity",
      ...
      "points": [
        {
          "paradigm": "euler-cz-sandwich",
          "model": "sonnet-5",
          "run_repo": "https://github.com/craigm26/run-ghz3he-craigm26",
          "metric": 1,
          "cost": 2,
          "reference": false,
          "dominated": false
      ...
      "gap": "Only one verified entry so far (euler-cz-sandwich, fidelity 1 at 2 2q gates) — the frontier is a single point. A second paradigm at a different cost is untried."
    }
  },
  "paradigms": [
    {
  ...
  "changelog": [
    {
      ...
      "problem_id": "tfim3",
      "date": "2026-06-16",
      "detail": "hardware-efficient took rank 1 from qaoa — metric 0.000103138 → 0.014258",
      "run_repo": "https://github.com/QuantumMytheme/run-tfim3-hwe",
    ...
    },
    {
      ...
      "problem_id": "ghz3_he",
      "date": "2026-07-01",
      "detail": "board opened — first verified design: euler-cz-sandwich (metric 1)",
      "run_repo": "https://github.com/craigm26/run-ghz3he-craigm26",
      "proof_bundle": "bench/quantum-judge/quantum-proof-ghz3he-craigm26.json",
      "seq": 9
    },
    {
      "type": "NEW_LEADER",
