...
(function () {
  ...
  var IMPOSTORS = {
    ...
    'ghz3-3cx': { file: 'quantum-proof-ghz3-3CX.json', refId: 'ghz3', label: 'GHZ₃ at perfect fidelity — but 3 entangling gates', expect: 3, trap: 'Fidelity 1.0, honestly claimed — a genuinely correct circuit. But it spends 3 two-qubit gates where the reference caps the budget at 2. The cap is pinned host-side, so declaring a looser budget in the bundle does not help.' },
    'ghz3-underpowered': { file: 'quantum-proof-ghz3-UNDERPOWERED.json', refId: 'ghz3', label: 'GHZ₃ under-rotated — 0.976 fidelity, honestly claimed', expect: 5, trap: 'RY(0.6π) instead of the exact H, then the real cascade. The claim exactly matches what the judge recomputes — no lie here — and it clears the classical baseline (0.5) by a wide margin. It is simply short of the 0.99 bar: correct, reproducible, and still not good enough.' }
  };
